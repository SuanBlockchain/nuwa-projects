    ...
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
      ...
      <div className="bg-white dark:bg-surface-dark border border-gray-200 dark:border-border-dark rounded-2xl p-6 md:p-8">
        ...
        <div className="space-y-4">
          {/* From Address */}
          <div className="flex flex-col gap-1 p-4 bg-gray-50 dark:bg-background-dark rounded-lg">
            <span className="text-gray-600 dark:text-gray-400 text-xs font-medium">From</span>
          ...
          {/* To Address */}
          <div className="flex flex-col gap-1 p-4 bg-gray-50 dark:bg-background-dark rounded-lg">
            <span className="text-gray-600 dark:text-gray-400 text-xs font-medium">To</span>
            <span className="text-gray-900 dark:text-white text-sm font-mono break-all">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-1 p-4 bg-gray-50 dark:bg-background-dark rounded-lg">
              <span className="text-gray-600 dark:text-gray-400 text-xs font-medium">Amount</span>
            ...
            <div className="flex flex-col gap-1 p-4 bg-gray-50 dark:bg-background-dark rounded-lg">
              <span className="text-gray-600 dark:text-gray-400 text-xs font-medium">Est. Fee</span>
          ...
          <div className="flex flex-col gap-1 p-4 bg-primary/10 border border-primary/20 rounded-lg">
            <span className="text-gray-600 dark:text-gray-400 text-xs font-medium">Total (Amount + Fee)</span>
          ...
          {buildResponse.metadata && (
            <div className="flex flex-col gap-1 p-4 bg-gray-50 dark:bg-background-dark rounded-lg">
              <span className="text-gray-600 dark:text-gray-400 text-xs font-medium">Metadata</span>
              <pre className="text-gray-900 dark:text-white text-xs font-mono overflow-x-auto">
      ...
      <div className="bg-white dark:bg-surface-dark border border-gray-200 dark:border-border-dark rounded-2xl p-6 md:p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Sign Transaction</h2>
        </div>

        <div className="flex flex-col gap-2">
          <label htmlFor="password" className="text-gray-900 dark:text-white text-sm font-medium">
            Wallet Password
          </label>
          <input
            id="password"
            ...
            {...register('password')}
            className="w-full bg-gray-50 dark:bg-background-dark border border-gray-200 dark:border-border-dark text-gray-900 dark:text-white rounded-xl h-12 px-4 focus:ring-2 focus:ring-primary focus:border-transparent focus:outline-none transition-all placeholder:text-gray-400 dark:placeholder:text-gray-600"
          />
          {errors.password && (
        ...
        <div className="mt-6 p-4 rounded-xl bg-yellow-500/5 border border-yellow-500/20">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="text-gray-900 dark:text-white text-sm font-bold mb-1">Review Carefully</h4>
      ...
      <div className="flex gap-4">
        <button
          ...
          onClick={onBack}
          disabled={loading}
          className="flex-1 h-12 bg-gray-100 dark:bg-surface-dark hover:bg-gray-200 dark:hover:bg-surface-darker border border-gray-200 dark:border-border-dark text-gray-900 dark:text-white text-base font-medium rounded-xl flex items-center justify-center gap-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
        >
